...
-- 2025-03-12,AEichholz,Completed File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_AEichholz')
	 Begin 
	  Alter Database [Assignment07DB_AEichholz] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_AEichholz;
	 End
	Create Database Assignment07DB_AEichholz;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_AEichholz;
